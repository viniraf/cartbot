...
Currency symbol is localized by language: English users see $, Portuguese users see R$.
...
MESSAGES = {
    ...
    "ADD_ITEMS_COUNT_SINGULAR": "1 item added.",
    "ADD_ITEMS_COUNT_PLURAL": "{count} items added.",
    ...
    "FINISH_TITLE": "Purchase completed.",
    "FINISH_STORE": "Store: {store_name}",
    "FINISH_TOTAL_ITEMS": "Total items: {item_count}",
    "FINISH_TOTAL_AMOUNT": "Final amount: {total}",
